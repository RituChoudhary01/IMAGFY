    ...
    className='flex flex-col items-center justify-center my-24 p-6 md:px-28'>
      ...
      <div className='flex felx-col gap-5 md:gap-14 md:flex-row items-center'>
        ...
        <div >
          ...
          <p className='text-gray mb-4'>Easily bring your ideas to life with our free AI image generator.Whether you need stunning visuals or unique imagery, our tool transforms your text into eye-catching image with just a few click. Imagine it, descripe it, and watch it come to life instantly</p>
